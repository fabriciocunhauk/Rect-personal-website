...
function AboutMe() {
    return (
        <div>
            <p>I'm a Self-taught JavaScript full-stack developer passionate about technology and the future of the world.
            From the moment I produced "Hello World" in the console of my first application, I knew I was hooked into
